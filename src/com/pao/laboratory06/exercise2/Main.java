...
public class Main {
    ...
    public static TipColaborator getTip(Colaborator c) {
        return TipColaborator.valueOf(c.tipContract());
    }
    public static void main(String[] args) {
       ...
       for (Colaborator c : colaboratori) {
           typesOfCollaborators.add(getTip(c));
       }
